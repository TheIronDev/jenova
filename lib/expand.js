 ...
 * @param {String/Object} compressed - compressed game of life board
 * @param {Number} width - width of our matrix
...
function expand(compressed, width) {
  ...
  var decompressed = LZUTF8.decompress(compressedString, decompressedObject),

  // 001001 to ['0','0','1','0','0','1']
    decompressedToArray = decompressed.split(''),

  // Map ['1'] to [1], then reduce to a matrix [ [1] ]
    result = decompressedToArray.map(function(cell) {
