 ...
 * @param options.rule {String} - String representation of how cells are born or survive.
 *      It defaults to "B3/S23", which means a dead cell is born if there are 3 neighbors, and survives with 2 or 3 neighbors
 *
 * @param options.updateCell {Function} - function that helps decide how our cell value changes.
